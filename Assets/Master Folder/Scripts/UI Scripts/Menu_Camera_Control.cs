...
public class Menu_Camera_Control : MonoBehaviour {
	...
	private Vector3 menuIsland, optionIsland, gameIsland, creditIsland;
	...
	void Start () 
	{
		...
		creditIsland = new Vector3 (23f, centre.position.y, 240f);
	}
	...
	void FixedUpdate () 
	{
		...
		case 4:
			...
			break;
		case 5:
			CameraMove (centre.position, creditIsland);
			break;
		}
	}
